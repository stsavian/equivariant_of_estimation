...
matlab_sign_imbalance_pth='/home/ssavian/training/img_formation_mat/TCSVT_repository/balanced_dataset_textured_std_60_radius_50_limit_dis1000_samples/data'
frL_pth=os.path.join(matlab_sign_imbalance_pth,'pair357_L.png')
frR_pth=os.path.join(matlab_sign_imbalance_pth,'pair357_R.png')
flo_pth=os.path.join(matlab_sign_imbalance_pth,'pair357_.flo')

dest_path='/home/ssavian/training/plots_ironspeed/visualization/kaleidoscope'
...
imwrite(os.path.join(dest_path,'gnd_vis.png'),utils.flow.flow_to_png_middlebury(target))
