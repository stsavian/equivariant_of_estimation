...
dest_path='/home/ssavian/training/visualization/raft-things_Kaleidoscope/'

##save everything
#destination

def save_Kaleidoscope_visualizations(model_inference,dataset_pth,dest_path,mode='training'):
    if not os.path.exists(dest_path):
        os.makedirs(dest_path)
...
save_Kaleidoscope_visualizations(RAFT_inference,\
            '/home/ssavian/training/img_formation_mat/TCSVT_repository/balanced_dataset_textured_std_60_radius_50_limit_dis1000_samples',dest_path,mode='training')
