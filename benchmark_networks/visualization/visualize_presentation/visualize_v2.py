...
frL_pth='/media/ssavian/Data1/EVALUATION/WACV_vis_fig1/inputs_left/input_Lcheck.png'
frR_pth='/media/ssavian/Data1/EVALUATION/WACV_vis_fig1/inputs_left/input_Rcheck.png'
flo_pth='/media/ssavian/Data1/EVALUATION/WACV_vis_fig1/inputs_left/gnd.flo'
...
dest_path='/media/ssavian/Data1/EVALUATION/WACV_vis_fig1_c_left/'
...
imwrite(os.path.join(dest_path,type+'gnd_vis_180.png'),utils.flow.flow_to_png_middlebury(-GND))
...
imwrite(os.path.join(dest_path,type+'minus_out_star_vis.png'),utils.flow.flow_to_png_middlebury(-out_star))
