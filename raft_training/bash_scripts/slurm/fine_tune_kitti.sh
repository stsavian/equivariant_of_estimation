...
restore_ckpt=/scratch/ssavian/RAFT_trained_models/sintel_no_mir_fine_tune_RAFT_chairs_no_mirror/sintel_no_mir_fine_tune_RAFT_chairs_no_mirror.pth
name_training=kitti_no_mirror_fine_tune_sintel_no_mirror
beta=0.0
...
#restore_ckpt=/scratch/ssavian/RAFT_trained_models/sintel_baseline_fine_tune_raft_things_mir_batch5/sintel_baseline_fine_tune_raft_things_mir_batch5.pth
#name_training=kitti_fine_tune_sintel_baseline
#beta=0.0
#
#echo $name_training
#/home/clusterusers/ssavian/.conda/envs/raft/bin/python -u /home/clusterusers/ssavian/raft/project/original_repo/train.py \
...
#######################
#### TESTING FINE TUNE SINTEL B1.0
#######################

#options="--mixed_precision --add_mirroring --no_grad_on_rot_input --double_fwd"
#restore_ckpt=/scratch/ssavian/RAFT_trained_models/sintel_b10_fine_tune_chairs_b10_things_b10/sintel_b10_fine_tune_chairs_b10_things_b10.pth
#name_training=kitti_b10_sintel10_FWDS_mir
#beta=1.0
#
#echo $name_training
#/home/clusterusers/ssavian/.conda/envs/raft/bin/python -u /home/clusterusers/ssavian/raft/project/original_repo/train.py \
...
#######################
#### TESTING FINE TUNE SINTEL B0.5
#######################

#options="--mixed_precision --add_mirroring --no_grad_on_rot_input --double_fwd"
#restore_ckpt=/scratch/ssavian/RAFT_trained_models/sintel_b05_fine_tune_chairs_b10_things_b10/sintel_b05_fine_tune_chairs_b10_things_b10.pth
#name_training=kitti_b05_sintel10_FWDS_mir
#beta=0.5
#
#echo $name_training
#/home/clusterusers/ssavian/.conda/envs/raft/bin/python -u /home/clusterusers/ssavian/raft/project/original_repo/train.py \
