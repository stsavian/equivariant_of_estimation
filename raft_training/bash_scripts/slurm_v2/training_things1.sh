...
options="--mixed_precision   --no_grad_on_rot_input --train_on_average_epe"
restore_ckpt=/scratch/ssavian/RAFT_trained_models_v2/raft-chairs-no-mir_b06_FWDS_o-mean/raft-chairs-no-mir_b06_FWDS_o-mean.pth
name_training=raft-chairs-no-mir_b06_FWDS_o-mean_fine_thned_things
beta=0.6
echo $name_training
