...
options="--mixed_precision --no_grad_on_rot_input --double_fwd --train_on_average_epe"
chairs2_direction=fwd
beta=0.6
name_training="raft-chairs-no-mir_b06_FWDS_o-mean"
echo $name_training
...
restore_ckpt=/scratch/ssavian/RAFT_trained_models_v2/raft-chairs-mir/raft-chairs-mir.pth
name_training=RAFT_things-mir_beta_06_o-mean
beta=0.6
echo $name_training
/home/clusterusers/ssavian/.conda/envs/raft/bin/python -u /home/clusterusers/ssavian/raft/project/original_repo/train.py \
