...
options="--mixed_precision --add_mirroring --double_fwd  --no_grad_on_rot_input --train_on_average_epe"
restore_ckpt=/scratch/ssavian/RAFT_trained_models_v2/raft-chairs-mir_b10_FWDS_o-mean/raft-chairs-mir_b10_FWDS_o-mean.pth
name_training=RAFT-things-mir_b10_FWDS_o-mean
beta=1.0
echo $name_training
