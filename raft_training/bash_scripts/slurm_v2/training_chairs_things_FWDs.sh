...
#options="--mixed_precision  --average_loss --double_fwd --train_on_average_epe"#--no_grad_on_rot_input
#options="--mixed_precision --add_mirroring  --double_fwd --train_on_average_epe"
options="--mixed_precision --add_mirroring --double_fwd --train_on_average_epe"
chairs2_direction=fwd
beta=0.3
name_training="raft-chairs-mir_b03_FWDS_o-mean_v2"
echo $name_training
